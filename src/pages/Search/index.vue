    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <!-- 分类的面包屑 -->
            <li class="with-x" v-if="searchParams.catgoryName">{{searchParams.catgoryName}}<i @click="removeCategoryName">×</i></li>
            <!-- 关键字的面包屑 -->
...
export default {
  ...
  methods: {
    ...
    // 排序的操作
    changeOrder(flag){
      // flag 形参：他是一个标记，代表用户点击的是综合（1）或者价格（2）
  ...
  watch:{
    // 监听路由信息是否发生变化，如果发生变化，再次发生请求
    $route(newValue, oldValue){
      // 每一次请求完毕，把相应的1、2、3级分类的id 置空
